$(function () {
  ...
  $('.states').on('change', function () {
    ...
    } else $('.locations h4').html(Object.values(checked).join(', '));
  });
  ...
  $('button[type="button"]').click(function () {
    let amenityIds = Object.keys(checked),
      stateIds = Object.keys(checkedStates),
      cityIds = Object.keys(checkedCities);
    ...
    $.ajax({
      ...
      success: function (response) {
        response = response.filter(p => p.city_id in cityIds);
